...
public class UserRequestDto {
    ...
    @NotNull(groups = {ValidUser0003.class},
            message = "사용자 확인 정보(userIdx)가 누락되었습니다.")
    @Min(groups = {ValidUser0003.class},
        message = "사용자 idx는 최소 1 이상이어야 합니다.", value = 1)
    ...
    @Pattern(regexp = "^[a-z가-힣]{2,10}$",
            groups = {ValidUser0001.class, ValidUser0003.class},
